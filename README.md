# MovieServiceExample
Most of this application was generated by Meelis Annus (Goods and Services OÜ) using JHipster 4.0.7, you can find documentation and help at [https://jhipster.github.io/documentation-archive/v4.0.7](https://jhipster.github.io/documentation-archive/v4.0.7).
...
To optimize the MovieServiceExample application for production, run:
